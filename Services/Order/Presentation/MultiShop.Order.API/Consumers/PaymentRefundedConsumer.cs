namespace MultiShop.Order.API.Consumers
{
    ...
    public class PaymentRefundedConsumer : BackgroundService
    {
        ...
        public PaymentRefundedConsumer(IServiceProvider serviceProvider, IConfiguration configuration, ILogger<PaymentRefundedConsumer> logger)
        {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            return Task.Run(async () =>
            {
                ...
                consumer.Subscribe(KafkaTopics.PaymentRefunded);
                ...
                while (!stoppingToken.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        var message = JsonSerializer.Deserialize<PaymentRefundedEvent>(result.Message.Value);
                        ...
                        if (order is not null)
                        {
                            ...
                            await dbContext.ProcessedEvents.AddAsync(new ProcessedEvent
                            {
                                ...
                                HandlerName = nameof(PaymentRefundedConsumer),
