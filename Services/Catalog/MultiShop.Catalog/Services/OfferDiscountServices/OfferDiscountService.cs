...
namespace MultiShop.Catalog.Services.OfferDiscountServices
{
    public class OfferDiscountService : IOfferDiscountService
    {
        ...
        public OfferDiscountService(IMapper mapper, IDatabaseSettings _databaseSetings)
        {
            _mapper = mapper;
            ...
            _offerDiscountCollection = database.GetCollection<OfferDiscount>(_databaseSetings.OfferDiscountCollectionName);
